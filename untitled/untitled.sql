...
FROM
  salesman
WHERE
  commision BETWEEN 0.12 AND 0.14;
...
VALUES
  (101, 'Mother Board', 3200.00, 15) GO
INSERT INTO
  item_mast (pro_id, pro_name, pro_price, pro_com)
VALUES
  ...
  (109, 'Refill cartridge', 350.00, 13) GO
INSERT INTO
  item_mast (pro_id, pro_name, pro_price, pro_com)
VALUES
  (110, 'Mosue', 250.00, 12) GO
SELECT
  *
FROM
  item_mast
